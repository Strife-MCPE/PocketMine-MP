		...
		foreach(Utils::promoteKeys($biomeEntries) as $biomeName => $entry){
			...
			try{
				...
				$entries[] = new BiomeDefinitionEntry(
					...
					0.0, //TODO: redSporeDensity - not currently exposed by BiomeDefinitionEntryData
					0.0, //TODO: blueSporeDensity - not currently exposed by BiomeDefinitionEntryData
					0.0, //TODO: ashDensity - not currently exposed by BiomeDefinitionEntryData
					0.0, //TODO: whiteAshDensity - not currently exposed by BiomeDefinitionEntryData
