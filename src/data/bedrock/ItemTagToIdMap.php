...
final class ItemTagToIdMap{
	...
	private const PATHS = [
		...
		ProtocolInfo::PROTOCOL_1_26_20 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_26_10 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_26_0 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_130 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_124 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_120 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_111 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_100 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_93 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_90 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_80 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_70 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_60 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_50 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_40 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_30 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_20 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_2 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_21_0 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_20_80 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_20_70 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_20_60 => "-1.26.30",
		ProtocolInfo::PROTOCOL_1_20_50 => "-1.26.30",
